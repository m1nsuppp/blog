...
올해 가장 꾸준했던 건 운동이다. 시작은 여자친구 때문이었다. 새해니까 같이 운동하자고 하는데, 솔직히 나는 하기 싫었다. 10시쯤 출근해서 퇴근하면 밤 11시~12시인 날이 많았으니 운동할 시간이 어디 있나 생각했다. 그래도 여자친구가 같이 하고 싶어하니까 그냥 시작했다.

막상 해보니 나름 재밌었고, 건강한 루틴을 갖게 된 느낌이 좋았다. 일하다가 짬을 내서 다녀오곤 했다. 물론 운동 후, 다시 일하는 날이 대부분이었지만...
...
먼저 고객사마다 다른 비즈니스 규칙과 요구사항을 코드 수준에서 데이터 수준으로 이동시켰다. 이 부분은 [예전 글](/blog/multi-tenant-configuration-model)에서 자세히 다뤘으니 여기서는 접어두겠다.

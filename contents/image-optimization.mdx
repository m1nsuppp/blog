...
UI를 통해 손쉽게 리사이징 옵션을 설정할 수 있습니다.
아래 사진에 보이는 것과 같이 왼쪽 사이드바 UI의 `Images` 탭을 선택하고, `Variants`를 선택합니다.

![sidebar](./images/image-optimization/sidebar.png)

그럼 아래와 같은 화면이 나오고, `Add New Variant`를 클릭해줍니다.

![variants](./images/image-optimization/variants.png)
...
![variant-options](./images/image-optimization/varaint-options.png)
...
![cf-cache](./images/image-optimization/cf-cache.png)
...
![lqip-options](./images/image-optimization/lqip-options.png)

원본 이미지(33.7KB) -> LQIP(588B)로 줄이며, 거의 60배에 가깝게 줄어든 것을 확인할 수 있습니다.

![raw-vs-lqip](./images/image-optimization/raw-vs-lqip.png)
